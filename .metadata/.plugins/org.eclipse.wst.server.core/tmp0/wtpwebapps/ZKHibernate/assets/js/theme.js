...
$(document).ready(function() {
	...
	$(".choose-skin li").on("click", function() {
		...
		$(".choose-skin li").removeClass("active"), t.addClass("active"), e.attr("data-avio", "theme-" + t.data("theme"))
	...
	var t = document.querySelector('.theme-switch input[type="checkbox"]'),
		...
		c = document.querySelector('.theme-dark input[type="checkbox"]'),
		e = localStorage.getItem("theme");
	e && (document.documentElement.setAttribute("data-theme", e), "dark" === e && (t.checked = !0, c.checked = !1, o.checked = !1), "theme-dark" === e && (c.checked = !0, o.checked = !1, t.checked = !1), "high-contrast" === e && (o.checked = !0, t.checked = !1, c.checked = !1)), t.addEventListener("change", function(e) {
		e.target.checked ? (document.documentElement.setAttribute("data-theme", "dark"), localStorage.setItem("theme", "dark"), o.checked = !1, c.checked = !1) : (document.documentElement.setAttribute("data-theme", "light"), localStorage.setItem("theme", "light"))
	}, !1), o.addEventListener("change", function(e) {
		e.target.checked ? (document.documentElement.setAttribute("data-theme", "high-contrast"), localStorage.setItem("theme", "high-contrast"), t.checked = !1, c.checked = !1) : (document.documentElement.setAttribute("data-theme", "light"), localStorage.setItem("theme", "light"))
	}, !1), c.addEventListener("change", function(e) {
		e.target.checked ? (document.documentElement.setAttribute("data-theme", "theme-dark"), localStorage.setItem("theme", "theme-dark"), t.checked = !1, o.checked = !1) : (document.documentElement.setAttribute("data-theme", "light"), localStorage.setItem("theme", "light"))
